...
- 723 entradas en 23 categorías y 133 subcategorías; el último build generó 1735 páginas.
- Tipos editoriales en uso: guides (417), resources (93), skills (80), libraries (40), patterns (19), recipes (19), utilities (12), hooks (9), practices (9), technologies (9), snippets (7), commands (4), tricks (3), integrations (2).
...
- Contenido real: 723 entradas Markdown propias en `src/content/docs/`.
