...
const BrandCss: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#1572B6" {...props}>
    <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm17.09 4.413L5.41 4.41l.213 2.622 10.125.002-.255 2.716h-6.64l.24 2.573h6.182l-.366 3.523-2.91.804-2.91-.804-.188-2.11h-2.61l.29 3.855L12 19.288l5.373-1.53L18.59 4.414z" />
  </svg>
);
...
const BrandNextjs: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#a1a1aa" {...props}>
...
/** Isotipo real de Node.js (el hexágono), geométrico, se lee bien incluso chico. */
const BrandNode: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#539E43" {...props}>
...
/** Isotipo real de HTML5 (el escudo), en su naranja de marca. */
const BrandHtml: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#E34F26" {...props}>
    <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z" />
  </svg>
);

/** Sin logo a color real para Express — glifo de texto, mismo estilo que TS/Zod. */
const BrandExpress: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" {...props}>
    <text
      x="12"
      y="16.5"
...
/** Isotipo real de Git (las dos ramas), en su naranja de marca. */
const BrandGit: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#F05033" {...props}>
...
/** Octocat de GitHub, en gris corporativo. */
const BrandGithub: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#a1a1aa" {...props}>
...
const BrandClaudeCode: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#D97757" {...props}>
...
const BrandOpencode: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#fb7185" {...props}>
    <path d="M22 24H2V0h20zM17 4.8H7v14.4h10z" />
  </svg>
);

/** Isotipo real de Cursor (el prisma facetado), en blanco (tema oscuro). */
const BrandCursor: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#38bdf8" {...props}>
    <path d="M11.503.131 1.891 5.678a.84.84 0 0 0-.42.726v11.188c0 .3.162.575.42.724l9.609 5.55a1 1 0 0 0 .998 0l9.61-5.55a.84.84 0 0 0 .42-.724V6.404a.84.84 0 0 0-.42-.726L12.497.131a1.01 1.01 0 0 0-.996 0M2.657 6.338h18.55c.263 0 .43.287.297.515L12.23 22.918c-.062.107-.229.064-.229-.06V12.335a.59.59 0 0 0-.295-.51l-9.11-5.257c-.109-.063-.064-.23.061-.23" />
  </svg>
);

/** Isotipo real de OpenAI (el nudo hexagonal), en blanco (tema oscuro) — Codex es producto de OpenAI. */
const BrandCodex: IconComponent = (props) => (
  <svg viewBox="0 0 24 24" fill="#10a37f" {...props}>
...
/** Iconos recoloreados para las subcategorías de recursos en IA Tools & Skills. */
const BrandIaComandos: IconComponent = (props) => <Terminal color="#34d399" {...props} />;
const BrandIaSkills: IconComponent = (props) => <Sparkles color="#fbbf24" {...props} />;
const BrandIaPlugins: IconComponent = (props) => <Blocks color="#a78bfa" {...props} />;
const BrandIaMcp: IconComponent = (props) => <Plug color="#22d3ee" {...props} />;

/** Iconos recoloreados en azul Docker para las subcategorías de DevOps. */
const BrandDockerConceptos: IconComponent = (props) => <Compass color="#2496ED" {...props} />;
const BrandDockerImagenes: IconComponent = (props) => <Layers color="#2496ED" {...props} />;
const BrandDockerContenedores: IconComponent = (props) => <Box color="#2496ED" {...props} />;
const BrandDockerRedesVolumenes: IconComponent = (props) => <Network color="#2496ED" {...props} />;
const BrandDockerCompose: IconComponent = (props) => <Workflow color="#2496ED" {...props} />;
const BrandDockerBasesDatos: IconComponent = (props) => <Database color="#2496ED" {...props} />;
const BrandCiCd: IconComponent = (props) => <Workflow color="#a78bfa" {...props} />;
const BrandObservabilidad: IconComponent = (props) => <Activity color="#22d3ee" {...props} />;
const BrandJavascript: IconComponent = (props) => <Braces color="#facc15" {...props} />;
...
/** Iconos recoloreados para las subcategorías de Arquitectura. */
const BrandPrincipios: IconComponent = (props) => <Scale color="#fb7185" {...props} />;
const BrandPatronesDiseno: IconComponent = (props) => <Puzzle color="#c084fc" {...props} />;
const BrandPatronesArquitectonicos: IconComponent = (props) => <Building2 color="#fb923c" {...props} />;
...
const ICONS: Record<string, IconComponent> = {
  ...
  'brand-utils': BrandTypescript,
  'brand-zod': BrandZod,
  'brand-astro': BrandAstro,
  'brand-nextjs': BrandNextjs,
  'brand-html': BrandHtml,
  'brand-react': BrandReact,
  'brand-node': BrandNode,
  'brand-express': BrandExpress,
  'brand-git': BrandGit,
  'brand-github': BrandGithub,
  'brand-claude-code': BrandClaudeCode,
  'brand-opencode': BrandOpencode,
  'brand-cursor': BrandCursor,
  'brand-codex': BrandCodex,
  'brand-ia-comandos': BrandIaComandos,
  'brand-ia-skills': BrandIaSkills,
  'brand-ia-plugins': BrandIaPlugins,
  'brand-ia-mcp': BrandIaMcp,
  'brand-docker-conceptos': BrandDockerConceptos,
  'brand-docker-imagenes': BrandDockerImagenes,
  'brand-docker-contenedores': BrandDockerContenedores,
  ...
  'brand-patrones-arquitectonicos': BrandPatronesArquitectonicos,
