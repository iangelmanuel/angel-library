...
export const CATEGORIES: Record<CategoryId, CategoryMeta> = {
  ...
  frontend: {
    ...
    label: 'Frontend',
    icon: 'monitor',
    description: 'Frontend, interfaz de usuario (UI), renderizado en el navegador y frameworks de componentes.',
    color: '--accent-indigo',
  },
  backend: {
    id: 'backend',
    label: 'Backend',
    icon: 'server',
    description: 'Servidores, interfaces de programación de aplicaciones (APIs) y arquitectura de backend.',
    color: '--accent-green',
  },
  database: {
    id: 'database',
    ...
    icon: 'database',
    description: 'Bases de datos, mapeadores objeto-relacionales (ORM), consultas y persistencia.',
    color: '--accent-purple',
  },
  ai: {
    id: 'ai',
    label: 'IA',
    icon: 'brain',
    description: 'Inteligencia artificial (IA): modelos, contexto, herramientas, recuperación y respuestas.',
    color: '--accent-pink',
  },
  devops: {
    id: 'devops',
    label: 'DevOps',
    icon: 'container',
    description: 'Desarrollo y operaciones (DevOps): entrega continua, despliegue, infraestructura y observabilidad.',
    color: '--accent-orange',
  },
  git: {
    id: 'git',
  ...
  terminal: {
    ...
    label: 'Terminal & CLI',
    icon: 'terminal',
    description: 'Terminales e interfaces de línea de comandos (CLI) para Windows, macOS y Linux.',
    color: '--accent-teal',
  },
  tools: {
    id: 'tools',
  ...
  applications: {
    ...
    label: 'Aplicaciones',
    icon: 'app-window',
    description: 'Aplicaciones de escritorio para editar código, trabajar en la terminal y desarrollar o probar APIs.',
    color: '--accent-indigo',
  },
  seo: {
    id: 'seo',
    label: 'SEO',
    icon: 'search-check',
    description: 'Optimización para motores de búsqueda (SEO): metadatos, rastreo, indexación y datos estructurados.',
    color: '--accent-lime',
  },
  accessibility: {
    id: 'accessibility',
  ...
  performance: {
    ...
    label: 'Performance',
    icon: 'gauge',
    description: 'Rendimiento de carga, renderizado, tiempo de ejecución y optimización de recursos.',
    color: '--accent-amber',
  },
  security: {
    id: 'security',
  ...
  testing: {
    ...
    label: 'Testing',
    icon: 'test-tube-2',
    description: 'Pruebas unitarias, de integración y de extremo a extremo (E2E), además de estrategias de validación.',
    color: '--accent-green',
  },
  'ui-ux': {
    id: 'ui-ux',
    label: 'UI / UX',
    icon: 'palette',
    description: 'Interfaz de usuario (UI), experiencia de usuario (UX), interacción y sistemas visuales.',
    color: '--accent-purple',
  },
  architecture: {
    id: 'architecture',
  ...
  skills: {
    ...
    icon: 'bot',
    description: 'Herramientas de inteligencia artificial (IA) para programar: agentes, skills, plugins y protocolos.',
    color: '--accent-pink',
  },
};
...
export const STACKS: Record<StackId, StackMeta> = {
  ...
  typescript: { id: 'typescript', label: 'TypeScript', icon: 'brand-typescript' },
  ...
  'seo-tecnico': { id: 'seo-tecnico', label: 'SEO técnico', icon: 'brand-seo-tecnico' },
  'seo-contenido': { id: 'seo-contenido', label: 'Contenido y autoridad', icon: 'brand-seo-contenido' },
  'database-fundamentos': { id: 'database-fundamentos', label: 'Fundamentos', icon: 'brand-database-fundamentos' },
  'database-modelado': { id: 'database-modelado', label: 'Modelado y relaciones', icon: 'brand-database-modelado' },
  'database-sql': { id: 'database-sql', label: 'SQL y consultas', icon: 'brand-database-sql' },
  'database-postgresql': { id: 'database-postgresql', label: 'PostgreSQL', icon: 'brand-database-postgresql' },
  'database-nosql': { id: 'database-nosql', label: 'NoSQL', icon: 'brand-database-nosql' },
  'database-operacion': { id: 'database-operacion', label: 'Operación y recuperación', icon: 'brand-database-operacion' },
  'ai-fundamentos': { id: 'ai-fundamentos', label: 'Fundamentos de IA', icon: 'brand-ai-fundamentos' },
  'ai-prompts': { id: 'ai-prompts', label: 'Prompts y contexto', icon: 'brand-ai-prompts' },
  'ai-rag': { id: 'ai-rag', label: 'Embeddings y RAG', icon: 'brand-ai-rag' },
  'ai-agentes': { id: 'ai-agentes', label: 'Agentes, herramientas y evaluación', icon: 'brand-ai-agentes' },
  'ai-sdk': { id: 'ai-sdk', label: 'SDK para IA', icon: 'brand-ai-sdk' },
  'tools-fundamentos': { id: 'tools-fundamentos', label: 'Flujo de herramientas', icon: 'brand-tools-fundamentos' },
  'tools-editor': { id: 'tools-editor', label: 'Editor y workspace', icon: 'brand-tools-editor' },
  'tools-calidad': { id: 'tools-calidad', label: 'Calidad de código', icon: 'brand-tools-calidad' },
  'tools-build': { id: 'tools-build', label: 'Build y paquetes', icon: 'brand-tools-build' },
  'tools-debugging': { id: 'tools-debugging', label: 'Depuración', icon: 'brand-tools-debugging' },
  'tools-documentacion': { id: 'tools-documentacion', label: 'Documentación técnica', icon: 'brand-tools-documentacion' },
  'a11y-fundamentos': { id: 'a11y-fundamentos', label: 'Fundamentos de accesibilidad', icon: 'brand-a11y-fundamentos' },
  'a11y-contenido': { id: 'a11y-contenido', label: 'Contenido perceptible', icon: 'brand-a11y-contenido' },
  'a11y-interaccion': { id: 'a11y-interaccion', label: 'Semántica e interacción', icon: 'brand-a11y-interaccion' },
  'a11y-testing': { id: 'a11y-testing', label: 'Pruebas de accesibilidad', icon: 'brand-a11y-testing' },
  'performance-fundamentos': { id: 'performance-fundamentos', label: 'Fundamentos y métricas', icon: 'brand-performance-fundamentos' },
  'performance-carga': { id: 'performance-carga', label: 'Carga y recursos', icon: 'brand-performance-carga' },
  'performance-runtime': { id: 'performance-runtime', label: 'JavaScript y renderizado', icon: 'brand-performance-runtime' },
  'performance-operacion': { id: 'performance-operacion', label: 'Red y operación', icon: 'brand-performance-operacion' },
  'security-fundamentos': { id: 'security-fundamentos', label: 'Fundamentos y amenazas', icon: 'brand-security-fundamentos' },
  'security-aplicacion': { id: 'security-aplicacion', label: 'Aplicación y API', icon: 'brand-security-aplicacion' },
  'security-infra': { id: 'security-infra', label: 'Infraestructura y disponibilidad', icon: 'brand-security-infra' },
  'security-testing': { id: 'security-testing', label: 'Verificación de seguridad', icon: 'brand-security-testing' },
  'testing-fundamentos': { id: 'testing-fundamentos', label: 'Fundamentos y estrategia', icon: 'brand-testing-fundamentos' },
  'testing-unitario': { id: 'testing-unitario', label: 'Pruebas unitarias', icon: 'brand-testing-unitario' },
  'testing-integracion': { id: 'testing-integracion', label: 'Integración y contratos', icon: 'brand-testing-integracion' },
  'testing-e2e': { id: 'testing-e2e', label: 'Pruebas E2E', icon: 'brand-testing-e2e' },
  'testing-ai': { id: 'testing-ai', label: 'Testing asistido por IA', icon: 'brand-testing-ai' },
  'apps-editors': { id: 'apps-editors', label: 'Editores de código', icon: 'brand-apps-editors' },
  'apps-terminal': { id: 'apps-terminal', label: 'Terminales', icon: 'brand-apps-terminal' },
  'apps-api': { id: 'apps-api', label: 'Clientes de API', icon: 'brand-apps-api' },
  'ui-ux-design-systems': { id: 'ui-ux-design-systems', label: 'Sistemas de diseño', icon: 'brand-ui-ux-design-systems' },
  'ui-ux-interaccion': { id: 'ui-ux-interaccion', label: 'Diseño de interacción', icon: 'brand-ui-ux-interaccion' },
  'ui-css': { id: 'ui-css', label: 'UI con CSS', icon: 'brand-ui-css' },
  'ui-react': { id: 'ui-react', label: 'UI con React', icon: 'brand-ui-react' },
  'cloud-fundamentos': { id: 'cloud-fundamentos', label: 'Fundamentos de nube', icon: 'brand-cloud-fundamentos' },
  'infraestructura-codigo': { id: 'infraestructura-codigo', label: 'Infraestructura como código', icon: 'brand-infraestructura-codigo' },
...
export const CATEGORY_STACK_ORDER: Partial<Record<CategoryId, readonly StackId[]>> = {
  ...
  accessibility: ['a11y-fundamentos', 'a11y-contenido', 'a11y-interaccion', 'a11y-testing'],
  performance: ['performance-fundamentos', 'performance-carga', 'performance-runtime', 'performance-operacion'],
  security: ['security-fundamentos', 'security-aplicacion', 'security-infra', 'security-testing'],
  testing: ['testing-fundamentos', 'testing-unitario', 'testing-integracion', 'react', 'astro', 'nextjs', 'testing-e2e', 'testing-ai'],
  applications: ['apps-editors', 'apps-terminal', 'apps-api'],
  skills: ['skills-fundamentos', 'claude-code', 'codex', 'cursor', 'opencode', 'ia-comandos', 'ia-skills', 'ia-plugins', 'ia-mcp'],
  'ui-ux': ['ui-ux-fundamentos', 'ui-ux-design-systems', 'ui-ux-interaccion', 'ui-css', 'ui-react'],
