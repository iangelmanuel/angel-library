...
Una prueba E2E confiable comienza en [Playwright práctico](/testing/testing-e2e/testing-playwright-practico): locators accesibles, web server controlado, datos aislados y aserciones con auto-wait. CI no corrige una prueba que ya depende de sleeps o estado compartido.
