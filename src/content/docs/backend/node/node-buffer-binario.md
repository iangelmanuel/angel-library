...
`BE` significa _big-endian_: el byte más significativo se almacena primero. Los protocolos binarios especifican tamaño y endianness; no se eligen de forma arbitraria.
