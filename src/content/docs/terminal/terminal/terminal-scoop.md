...
draft: false
scope: scoop
technologies: [applications/apps-cli/terminal-chocolatey]
...
- Para software que sí necesita instalarse a nivel de sistema (o que no está disponible en los buckets de Scoop), [Chocolatey](/applications/apps-cli/terminal-chocolatey) suele tener más cobertura.
