...
resourceCategory: ia
official: true
personalNote: "Estúdialo como arquitectura de producción reproducible: el agente coordina etapas y herramientas registradas, pero las decisiones editoriales siguen necesitando revisión humana."
