...
technologies: [devops/docker-conceptos/docker-arquitectura]
...
- En Windows/Mac, Docker igual necesita una VM liviana por debajo (Docker Desktop usa una VM con Linux, vía WSL2 en Windows) porque los contenedores Linux necesitan un kernel Linux — ver [Instalación](/devops/docker-conceptos/docker-instalacion).
