...
- `docker compose version` confirma que el plugin de Compose está disponible (viene incluido en Docker Desktop — ver [Docker Compose básico](/devops/docker-compose/docker-compose-basico)).
