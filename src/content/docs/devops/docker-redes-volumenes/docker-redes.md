...
draft: false
scope: redes
technologies: [devops/docker-compose/docker-compose-multi-servicio]
...
Esto es exactamente lo que `docker compose` hace automáticamente por debajo (ver [Docker Compose básico](/devops/docker-compose/docker-compose-basico)) — cada servicio de un `docker-compose.yml` queda accesible por su nombre de servicio desde los demás, sin crear la red a mano.
