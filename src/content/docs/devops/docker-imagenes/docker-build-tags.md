...
- Para publicar la imagen a un registry, el nombre necesita el prefijo del registry — ver [Docker Hub y registries](/devops/docker-imagenes/docker-registry-hub).
