...
draft: false
scope: registries
technologies: [devops/docker-imagenes/docker-build-tags]
...
- Nunca pushear una imagen con secretos incluidos (ver [.dockerignore](/devops/docker-imagenes/docker-dockerignore)) — una imagen pública en Docker Hub es descargable por cualquiera.
