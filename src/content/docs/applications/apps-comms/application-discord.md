...
technologies: [git/github-actions/github-actions-secretos-permisos]
...
Este es el mecanismo detrás de notificar un pipeline de GitHub Actions al terminar un deploy o al fallar un build: el workflow guarda la URL del webhook como secreto (ver [secretos y permisos en Actions](/git/github-actions/github-actions-secretos-permisos)) y hace ese `POST` como último paso.
