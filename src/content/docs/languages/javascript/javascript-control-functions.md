...
El control de flujo decide qué instrucciones se ejecutan y cuántas veces. La condición se convierte a booleano: `false`, `0`, `-0`, `0n`, `''`, `null`, `undefined` y `NaN` son valores _falsy_; el resto es _truthy_, incluidos `[]` y `{}`.
