...
- Antes de abrir una solicitud de cambios (PR), como paso automático al final de una sesión de trabajo.
- Como segunda opinión sobre código que el mismo agente acaba de escribir, no solo sobre código humano.

## Consideraciones

- Ver también el [comando /review](/skills/ia-comandos/comando-review) de esta misma biblioteca — mismo propósito, formato de comando explícito en vez de skill auto-activable. Elegir uno u otro según si prefieres control manual o activación automática.
