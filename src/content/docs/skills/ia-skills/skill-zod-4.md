...
draft: false
tool: Cross-tool
technologies: [packages/javascript-zod/zod, backend/express/express-jwt]
...
- Cualquier proyecto en esta biblioteca que use Zod — que es prácticamente todos: validación de `.env`, [React Hook Form + Zod](/frontend/react/react-hook-form-zod), body de requests en Express.
...
- Para patrones más avanzados (schemas recursivos con `z.lazy()`, tuning de performance), ver también [zod-schema-validation](/skills/ia-skills/skill-zod-schema-validation) — complementario, no superpuesto.
