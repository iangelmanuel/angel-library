...
- Escribiendo tests con Vitest en cualquier parte del stack — frontend o [backend](/packages/node-vitest/vitest-backend), la API es la misma.
...
- Para tests de integración HTTP específicamente (no solo unitarios), ver [Supertest](/packages/node-supertest/supertest) en esta misma biblioteca — cubre el caso puntual de testear una app Express completa que este skill no cubre en detalle.
