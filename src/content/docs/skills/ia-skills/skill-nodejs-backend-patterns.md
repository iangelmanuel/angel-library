...
- Arrancando un backend Express nuevo — complementa directo la [estructura MVC](/backend/express/backend-mvc-structure) y las guías de [middlewares](/backend/express/express-middlewares)/[auth](/backend/express/express-jwt) de esta biblioteca.
...
- Combinar con [express-typescript](/skills/ia-skills/skill-express-typescript) si el proyecto además necesita convenciones estrictas de TypeScript (naming, RO-RO pattern, organización de archivos).
