...
- Distinto de [`/review`](/skills/ia-comandos/comando-review) (que mira el diff actual) y de [`/security-audit`](/skills/ia-comandos/comando-security-audit) (foco en seguridad) — este mira la salud general del código existente, sin importar si cambió hoy.
