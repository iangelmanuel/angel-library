...
Plugin oficial que trae comandos de commit listos — mismo objetivo que el [comando /commit](/skills/ia-comandos/comando-commit) de esta biblioteca, empaquetado como plugin instalable en vez de copiar el archivo a mano.
