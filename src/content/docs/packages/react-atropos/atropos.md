...
- Es puramente visual/decorativo: para algo que además necesita gestos complejos (drag, swipe con física), esto no alcanza — ahí entra [Motion](/packages/react-motion/motion).
