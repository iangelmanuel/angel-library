...
- Para proyectos que ya usan [TanStack Query](/packages/react-tanstack-query/tanstack-query) para cachear datos, axios sigue siendo útil como el "fetcher" de adentro — Query maneja el cache/estado, axios hace la llamada en sí.
