...
technologies: [packages/node-vitest/vitest-backend]
...
- Para rutas que tocan la base de datos real, combinar con la base de test de [Vitest](/packages/node-vitest/vitest-backend) — sin eso, estos tests fallarían (o peor, escribirían) contra la base de desarrollo/producción.
