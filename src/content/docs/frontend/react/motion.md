...
- Para animaciones puramente de entrada/hover sin gestos complejos ni salida animada, `animation-timeline: view()` en CSS cubre el caso sin dependencia — ver [Animaciones CSS](/languages/css/css-animations). Motion vale la pena cuando necesitas layout animations, gestos (`drag`), o coordinar salida/entrada.
