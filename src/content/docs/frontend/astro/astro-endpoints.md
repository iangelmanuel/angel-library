...
- Para lo que sería un formulario típico con validación, [Server Actions](/frontend/astro/astro-server-actions) suele ser menos código que un endpoint a mano.
