...
Para un caso real con dos procesos de `dev` que no terminan (un backend y un frontend) corriendo a la vez con un solo comando, ver el [ejemplo completo de frontend + backend](/general/monorepo/monorepo-ejemplo-frontend-backend#pnpm).
