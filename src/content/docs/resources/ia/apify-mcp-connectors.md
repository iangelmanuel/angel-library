...
note: Útil para descubrir flujos de agentes que leen datos web o escriben en otras aplicaciones; revisa autor, permisos, precio, manejo de tokens y cumplimiento del sitio origen antes de ejecutar un Actor.
