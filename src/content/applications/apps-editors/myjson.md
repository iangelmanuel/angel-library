...
_workbench_, es decir, el espacio de trabajo completo de VS Code: paneles,
...
**Terminología:** la _activity bar_ es la barra de vistas principales y la
_sidebar_ es el panel que muestra el contenido de la vista seleccionada.

### 3. Terminal y variables de entorno

La terminal integrada ejecuta un _shell_, el programa que interpreta comandos
...
_File nesting_ crea una relación visual padre-hijo. No mueve, renombra ni
