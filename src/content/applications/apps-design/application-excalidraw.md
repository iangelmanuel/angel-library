...
Para un diagrama rápido en una reunión, un boceto de flujo antes de escribir código, o una arquitectura que se explica mejor con cajas y flechas que con prosa. No es la herramienta para un mockup de interfaz con precisión de píxel — ahí la herramienta correcta es [Figma](/applications/apps-design/application-figma).
