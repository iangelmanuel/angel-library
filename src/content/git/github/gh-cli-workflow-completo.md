...
Ver [Ramas](/git/git/git-ramas) para más sobre convenciones de nombres.
...
Combinar commits intermedios tipo "wip" o "fix typo" en algo legible — ver [Rebase interactivo](/git/git/git-rebase-interactivo). Si el historial ya está limpio, se salta este paso.
...
Ver [gh CLI — Pull Requests](/git/github/gh-cli-pull-requests) para variantes (`--draft`, `--base`, etc.).
