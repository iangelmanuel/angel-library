...
Igual que en un merge o rebase — Git para, deja los marcadores de conflicto en los archivos afectados (ver [Resolver conflictos](/git/git/git-resolver-conflictos)):
