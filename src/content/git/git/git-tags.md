...
- En GitHub, crear un **Release** desde un tag (vía web o `gh release create`, ver [gh CLI](/git/github/gh-cli-repos)) le agrega notas de la versión y archivos adjuntos — el tag es la base, el Release es la envoltura con más contexto alrededor.
