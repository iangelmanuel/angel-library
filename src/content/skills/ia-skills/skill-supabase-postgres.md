...
Se enfoca específicamente en la capa de base de datos de Supabase — cómo diseñar el schema, escribir políticas de Row Level Security correctas, indexar bien, y evitar queries lentas. Más profundo en esta parte puntual que el skill general de [supabase](/skills/ia-skills/skill-supabase).
...
- Instalar junto al skill general [supabase](/skills/ia-skills/skill-supabase) — este es un complemento específico de la capa de datos, no un reemplazo.
