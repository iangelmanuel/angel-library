...
- Complementa las guías de esta biblioteca — [Prisma en Express](/backend/express/express-prisma), [Prisma en Astro](/backend/astro/astro-prisma), [Prisma en Next.js](/backend/nextjs/nextjs-prisma) cubren la integración con cada framework; este skill cubre convenciones del schema en sí, independiente del framework.
