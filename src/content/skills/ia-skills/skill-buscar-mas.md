...
Para stacks de este proyecto sin un topic dedicado (Astro, Express, Git, Zod), buscar directo en [skills.sh](https://www.skills.sh) o usar el skill [find-skills](/skills/ia-skills/skill-find-skills), que busca por descripción de la tarea en vez de por categoría fija.
