...
- Parte de la combinación "esencial" junto a [GitHub MCP](/skills/mcp-github) y [Context7](/skills/mcp-context7).
...
- Para una automatización más ligera dentro de la sesión, sin instalar un MCP adicional, consulta el skill [agent-browser](/skills/skill-agent-browser).
