...
| `instructions` | Archivos de reglas de proyecto (ver [Instrucciones](/skills/opencode-instrucciones)) |
| `tools` | Habilitar/deshabilitar tools por nombre o patrón |
| `mcp` | Servidores MCP (ver [MCP](/skills/opencode-mcp)) |
| `plugin` | Plugins vía npm (ver [Plugins](/skills/opencode-plugins)) |
