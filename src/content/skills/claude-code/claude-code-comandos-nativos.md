...
- Esta es la lista de comandos que **ya existen** sin crear nada — para comandos propios, ver [Skills](/skills/claude-code/claude-code-skills) o [Comandos slash](/skills/claude-code/claude-code-slash-commands).
