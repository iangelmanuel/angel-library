...
- Esta es la lista de comandos que **ya existen** sin crear nada — para comandos propios, ver [Skills](/skills/claude-code-skills) o [Comandos slash](/skills/claude-code-slash-commands).
