...
tool: Cross-tool
related: [skills/comando-fix-tests]
...
- Complementa a [`/fix-tests`](/skills/comando-fix-tests): este escribe tests nuevos donde no hay, el otro arregla fallas en tests que ya existen — flujos distintos, no se pisan.
