...
tool: Cross-tool
related: [skills/comando-changelog]
...
- Distinto de [`/changelog`](/skills/comando-changelog): este es para UN pull request puntual (audiencia: el reviewer), el otro es un historial acumulado entre tags (audiencia: cualquiera que lea el changelog del proyecto).
