...
- Parte de la combinación "esencial" junto a [Context7](/skills/mcp-context7) y [Playwright](/skills/mcp-playwright) — cubre la mayoría de los workflows de desarrollo típicos.
