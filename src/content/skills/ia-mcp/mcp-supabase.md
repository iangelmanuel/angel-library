...
- Combinado con las guías de esta biblioteca — [Supabase](/backend/express/express-supabase) (o la versión Astro/Next.js) para la integración en código, este MCP para explorar/gestionar la base interactivamente.
