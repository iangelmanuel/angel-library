...
- Para un suite completo de comandos de revisión (seguridad, arquitectura, features) más elaborado que esto, ver [Claude Command Suite](/skills/ia-comandos/comando-claude-command-suite) — un recurso comunitario con 55+ comandos/agentes ya armados.
