...
- Complementa (no reemplaza) el [comando /security-audit](/skills/ia-comandos/comando-security-audit) de esta biblioteca — el comando es una auditoría puntual bajo demanda, este plugin integra la guía de seguridad de forma continua.
