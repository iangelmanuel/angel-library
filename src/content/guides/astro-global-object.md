...
Lee lo que un [middleware](/guides/astro-middleware) haya guardado en `context.locals` para esa request — así una página no repite la misma lógica que ya corrió antes.
