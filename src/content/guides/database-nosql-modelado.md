...
Esta página explica decisiones comunes a los modelos NoSQL. Después continúa con [MongoDB práctico](/guides/database-mongodb-practico) para documentos y [Redis práctico](/guides/database-redis-practico) para estructuras en memoria, expiración y caché.
