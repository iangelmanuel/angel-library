...
related: [guides/docker-run-basico, guides/docker-dockerignore]
...
La forma correcta: secretos siempre entran en **runtime**, vía `-e`/`--env-file` (o el equivalente en Compose — ver [Variables con Compose](/guides/docker-compose-variables)), nunca horneados en la imagen.
