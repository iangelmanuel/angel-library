...
`useSearchParams` es de solo lectura — para cambiar la URL se arma el nuevo string y se navega con `router.push` del hook [`useRouter`](/guides/nextjs-userouter) (ver esa entrada para el resto de sus métodos), o con un `<Link>`.
