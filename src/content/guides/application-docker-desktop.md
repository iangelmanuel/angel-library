...
related:
  - guides/docker-que-es
  - guides/docker-instalacion
  - guides/docker-arquitectura
...
En Linux, Docker Desktop es una aplicación aparte del **Docker Engine** que ya se documenta en [Instalación de Docker](/guides/docker-instalacion) — ahí la terminal es la única interfaz, sin la capa gráfica de este artículo.
