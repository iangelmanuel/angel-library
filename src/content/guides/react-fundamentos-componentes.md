...
Continúa con [estado como snapshot e inmutabilidad](/guides/react-state-snapshots-immutability) y después estudia `useState`. Los hooks son más fáciles de recordar cuando primero se comprende el ciclo render → commit → evento → nuevo render.
