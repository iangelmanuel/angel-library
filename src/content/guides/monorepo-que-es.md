...
- [Monorepo con pnpm](/guides/monorepo-pnpm) — el más usado para monorepos de JS/TS hoy, por su manejo de hoisting más estricto y los catalogs.
- [Monorepo con npm](/guides/monorepo-npm) — sin instalar nada extra si ya usas npm.
- [Monorepo con Bun](/guides/monorepo-bun) — instalación más rápida, runtime incluido.

Después de eso, [un ejemplo completo con frontend y backend](/guides/monorepo-ejemplo-frontend-backend) — Express, Vite + React, un paquete de tipos compartido, y el comando que abre ambos servidores a la vez en los tres gestores.
