...
Con el servicio arriba, el flujo de crear sesión, escanear el QR y enviar mensajes está en [OpenWA — sesiones y mensajes](/guides/openwa-sesiones-mensajes).
