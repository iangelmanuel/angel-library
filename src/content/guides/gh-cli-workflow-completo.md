---
title: Flujo completo — de una rama nueva a mergeado
...
Nunca ramificar desde una copia vieja de `main` — evita traer conflictos innecesarios más adelante solo por trabajar sobre una base desactualizada.
