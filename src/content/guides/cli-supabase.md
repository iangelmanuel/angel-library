...
Levantar el stack local (`supabase start`) requiere un runtime compatible con Docker en ejecución; revisa la [instalación de Docker](/guides/docker-instalacion). Instalar la CLI no instala Docker ni crea una cuenta.
