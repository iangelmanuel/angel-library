...
related: [guides/docker-volumenes, guides/docker-postgres-run]
...
- Ver [Levantar Postgres con docker run](/guides/docker-postgres-run) para el comando completo recomendado, con volumen incluido desde el principio.
