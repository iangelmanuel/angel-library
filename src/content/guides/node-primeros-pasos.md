...
1. [package.json](/guides/node-package-json): scripts, dependencias y versión.
2. [CommonJS vs ES Modules](/guides/node-commonjs-vs-esm): cómo se conectan archivos.
3. [Runtime y event loop](/guides/node-runtime-event-loop): cuándo el proceso puede bloquearse.
4. [Errores asíncronos](/guides/node-errores-asincronia): cómo propagar, cancelar y cerrar.
