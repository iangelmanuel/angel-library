...
related:
  ...
  - guides/repository-issues-planning
  - guides/git-colaboracion-pull-requests
...
| Pregunta | Documento |
| --- | --- |
| ¿Qué archivos debería tener? | [Archivos y documentación comunitaria](/guides/repository-files-community) |
| ¿Cómo convertir trabajo en Issues útiles? | [Issues, etiquetas y planificación](/guides/repository-issues-planning) |
| ¿Cómo preparar y revisar una PR? | [Pull Requests y revisión](/guides/git-colaboracion-pull-requests) |
| ¿Qué licencia corresponde? | [Licencias de software](/guides/repository-licenses) |
| ¿Cómo proteger la rama principal? | [Rulesets, automatización y seguridad](/guides/repository-rules-security) |
