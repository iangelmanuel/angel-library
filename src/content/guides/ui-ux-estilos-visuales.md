...
| --- | --- | --- | --- |
| [Skeuomorphism](/guides/ui-ux-estilo-skeuomorphism) | Imitar objetos reales | Enseñar una interfaz nueva | Envejece rápido, pesa mucho |
| [Neumorphism](/guides/ui-ux-estilo-neumorphism) | Elementos extruidos del fondo | Paneles suaves, sensación táctil | Contraste casi siempre insuficiente |
| [Glassmorphism](/guides/ui-ux-estilo-glassmorphism) | Vidrio esmerilado sobre el fondo | Jerarquía de capas | Texto ilegible según el fondo |
| [Claymorphism](/guides/ui-ux-estilo-claymorphism) | Formas infladas tipo plastilina | Productos amables, ilustrados | Se percibe como poco serio |
| [Minimalism](/guides/ui-ux-estilo-minimalism) | Quitar hasta lo esencial | Lectura, foco, rendimiento | Ambigüedad: se pierde el qué es cliqueable |
| [Maximalism](/guides/ui-ux-estilo-maximalism) | Abundancia deliberada | Marca, memorabilidad | Ruido y carga cognitiva |
| [Brutalism](/guides/ui-ux-estilo-brutalism) | Mostrar el material crudo | Portafolios, identidad fuerte | Se confunde descuido con estilo |
| [Liquid Glass](/guides/ui-ux-estilo-liquid-glass) | Vidrio con refracción y movimiento | Apps del ecosistema Apple | Costo de GPU, dependencia de plataforma |
| [Spatial UI](/guides/ui-ux-estilo-spatial-ui) | Interfaz en un espacio 3D | Visores y realidad mixta | Fatiga, ergonomía, público reducido |
