...
Se renderiza cuando la función `notFound()` se llama dentro de ese segmento (ver [redirect() y notFound()](/guides/nextjs-redirect-notfound)), o cuando la URL no matchea ninguna ruta.
