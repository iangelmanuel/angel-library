...
| `.env` | **Nunca** debe terminar dentro de la imagen: las variables secretas no van en su sistema de archivos; se inyectan en tiempo de ejecución con `-e` o `--env-file` (ver [Variables de entorno](/guides/docker-variables-entorno)) |
