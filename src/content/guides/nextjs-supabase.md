...
- No es mutuamente excluyente con [Prisma](/guides/nextjs-prisma) — se puede combinar Prisma para queries complejas y Supabase solo para auth/storage/realtime.
