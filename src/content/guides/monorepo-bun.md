...
Para un caso real con backend y frontend corriendo a la vez con un solo comando, ver el [ejemplo completo de frontend + backend](/guides/monorepo-ejemplo-frontend-backend#bun).
