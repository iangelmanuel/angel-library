...
related: [guides/docker-persistencia-datos, guides/docker-postgres-compose, guides/docker-postgres-conectar]
...
Esto levanta Postgres 16 en segundo plano, con un usuario, contraseña y base de datos ya creados, accesible en `localhost:5432`, y con los datos guardados en un volumen que sobrevive a `docker rm` (ver [Persistencia de datos](/guides/docker-persistencia-datos) para el porqué del `-v`).
