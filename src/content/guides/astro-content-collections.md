...
- Cambiar el `schema` no actualiza los tipos generados automáticamente en el editor: corré `astro sync` (o `pnpm sync` en este proyecto) después de tocar `content.config.ts`.
