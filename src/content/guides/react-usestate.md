...
- Cuando la lógica de "cómo cambia" el estado se vuelve compleja (varios campos relacionados, varias formas de actualizar), es momento de mirar [`useReducer`](/guides/react-usereducer) en vez de seguir sumando `useState` sueltos.
