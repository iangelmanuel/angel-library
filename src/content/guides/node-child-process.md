...
`spawn` devuelve **streams** (`stdout`/`stderr` son Readable, ver [Streams](/guides/node-streams)) en vez de esperar a tener todo junto — se puede procesar la salida a medida que llega, y funciona bien para procesos de larga duración o que producen mucha salida.
