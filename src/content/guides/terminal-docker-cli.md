...
La instalación completa — Docker Desktop, WSL2 en Windows, y los pasos previos — ya está cubierta en [Instalación de Docker](/guides/docker-instalacion). Esta guía asume que Docker ya está instalado y solo repasa el uso del CLI desde la terminal.
