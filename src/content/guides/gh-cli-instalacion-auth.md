...
related:
  - guides/gh-cli-workflow-completo
  - guides/gh-cli-repos
  - guides/gh-cli-pull-requests
  - guides/gh-cli-issues
...
- Continúa con el [flujo completo de GitHub CLI](/guides/gh-cli-workflow-completo) para repositorios, Issues, Pull Requests y Actions con más detalle.
