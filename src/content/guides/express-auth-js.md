...
- `Credentials` con contraseñas propias sigue necesitando hashear con [bcrypt](/libraries/bcrypt) a mano dentro de `authorize` — Auth.js no reemplaza esa parte, solo el manejo de sesión/providers alrededor.
