...
[MSW](/libraries/msw) conserva el `fetch` del componente y simula la frontera HTTP. Es más representativo que reemplazar el hook de datos o `global.fetch` con una respuesta incompleta.
