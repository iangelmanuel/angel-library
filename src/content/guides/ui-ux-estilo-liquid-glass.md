...
related:
  ...
  - guides/ui-ux-estilo-glassmorphism
...
Todo lo del [glassmorphism](/guides/ui-ux-estilo-glassmorphism) aplica multiplicado: `blur(18px) saturate(180%)` es más caro que un desenfoque solo, y añadir un brillo animado encima significa recomponer en cada movimiento del puntero.
