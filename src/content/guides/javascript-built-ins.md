...
| --- | --- | --- |
| `String` | [Strings](/guides/javascript-strings) | buscar, cortar, reemplazar, normalizar y trabajar con Unicode |
| `Number`, `BigInt`, `Math` | [Números y Math](/guides/javascript-numbers-math) | convertir, validar, redondear, calcular y manejar precisión |
| `Array` | [Arrays](/guides/javascript-arrays-objects) | transformar, filtrar, buscar, ordenar, acumular y copiar |
| `Object` | [Objetos](/guides/javascript-objects) | claves, desestructuración, copia, agrupación y descriptores |
| `Map`, `Set`, `WeakMap`, `WeakSet` | [Colecciones](/guides/javascript-collections) | índices dinámicos, unicidad y referencias débiles |
| `Date`, `RegExp`, `Intl` | [Fecha, patrones e internacionalización](/guides/javascript-date-regexp-intl) | instantes, coincidencias y presentación localizada |
| `Error` | [Errores y depuración](/guides/javascript-errors-debugging) | lanzar, capturar, clasificar, agregar causa y limpiar |
| `Promise` | [Código asíncrono](/guides/javascript-async-promises) | esperar, combinar, cancelar y manejar carreras |
| `ArrayBuffer`, TypedArray, `DataView` | [Datos binarios](/guides/javascript-binary-data) | bytes, vistas, endianness, transferencia y memoria compartida |
| `Iterator`, generators | [Iteradores](/guides/javascript-iterators-generators) | producir, transformar y consumir valores bajo demanda |
| `Symbol`, `Proxy`, `Reflect` | [Metaprogramación](/guides/javascript-advanced-language) | personalizar protocolos e interceptar operaciones |
