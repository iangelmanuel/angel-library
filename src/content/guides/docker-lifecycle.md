...
scope: ciclo de vida
related: [guides/docker-run-basico, guides/docker-ps-inspect]
...
- **Borrado**: `docker rm` elimina el contenedor por completo — su capa de escritura (cualquier archivo que haya creado o modificado) se pierde para siempre, salvo lo que estuviera en un volumen (ver [Volúmenes](/guides/docker-volumenes)).
