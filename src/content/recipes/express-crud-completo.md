...
technologies:
  ...
  - guides/express-prisma
  - guides/express-api-error-responses
updatedAt: 2026-08-16
---

## Piezas que se combinan

[REST/CRUD](/guides/express-rest-crud) (convenciones de rutas y status codes) + [Prisma](/guides/express-prisma) (persistencia) + [respuestas de error](/guides/express-api-error-responses) (formato consistente).
...
- Este ejemplo no incluye auth ni ownership (cualquiera puede editar cualquier post) — combinar con [Middleware de autenticación](/guides/express-auth-middleware) y el nivel de ownership de [Roles y permisos](/guides/express-roles-permisos) para una versión protegida real (ver también [API protegida](/recipes/express-api-protegida)).
