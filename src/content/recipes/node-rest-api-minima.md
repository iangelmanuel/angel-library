...
- **Middlewares**: parseo de body, CORS, auth, logging — como piezas reutilizables en vez de código repetido en cada handler (ver [Middlewares en Express](/guides/express-middlewares)).
