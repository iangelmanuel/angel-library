...
related: [patterns/adapter, patterns/backend-mvc-structure]
...
Esto es, en la práctica, lo que hace la capa de `services/` en una [estructura MVC de Express](/patterns/backend-mvc-structure): el service es la facade que el controller llama sin conocer los detalles.
