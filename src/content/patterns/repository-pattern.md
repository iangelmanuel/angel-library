...
related: [patterns/hexagonal-architecture, patterns/layered-architecture]
...
Este patrón es, en términos de arquitectura hexagonal, un puerto (`UserRepository`) con sus adaptadores (`PrismaUserRepository`, `InMemoryUserRepository`) — ver [Arquitectura hexagonal](/patterns/hexagonal-architecture) para el concepto general de puertos y adaptadores.
