...
related:
  ...
  - frontend/nextjs/nextjs-usesearchparams
  - frontend/nextjs/nextjs-link
updatedAt: 2026-08-25
---

[`<Link>`](/frontend/nextjs/nextjs-link) cubre la navegación normal (el usuario hace click en algo). `useRouter` es para cuando el código mismo decide navegar — después de un submit exitoso, un timeout, una condición que no depende de un click directo. Next recomienda `<Link>` como default y `useRouter` solo cuando hace falta control programático real.
