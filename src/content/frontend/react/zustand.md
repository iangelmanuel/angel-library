...
- A diferencia de [Context](/frontend/react/react-context-api), Zustand no necesita que el componente esté dentro de ningún Provider — el store es un módulo normal, importable desde cualquier lado, incluso fuera de componentes React.
