...
Las variables viven en el DOM, así que se leen con `getComputedStyle` y se escriben con `.style.setProperty`. Para leerlas, este sitio ya tiene [`getCssVar()`](/utilities/dom) en DOM Utils.
