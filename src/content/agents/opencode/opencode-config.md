...
| `instructions`          | Archivos de reglas de proyecto (ver [Instrucciones](/agents/opencode/opencode-instrucciones)) |
| `tools`                 | Habilitar/deshabilitar tools por nombre o patrón                                              |
| `mcp`                   | Servidores MCP (ver [MCP](/agents/opencode/opencode-mcp))                                     |
| `plugin`                | Plugins vía npm (ver [Plugins](/agents/opencode/opencode-plugins))                            |
