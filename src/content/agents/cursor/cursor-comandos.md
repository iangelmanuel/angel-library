...
- El **Cursor CLI** (la terminal, distinta del IDE) reconoce estos mismos comandos, además de tener su propio set grande de comandos nativos — ver [Comandos nativos](/agents/cursor/cursor-comandos-nativos).
