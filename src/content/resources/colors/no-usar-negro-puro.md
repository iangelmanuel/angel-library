...
La comprobación sigue siendo la misma: WCAG pide **4.5:1** para texto normal y **3:1** para texto grande. Bajar del negro puro a `#121212` no compromete esos umbrales, y se puede verificar con [Cool Contrast](/resources/colors/cool-contrast).
