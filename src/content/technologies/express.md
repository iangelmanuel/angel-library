...
Empieza en [Primeros pasos](/guides/express-primeros-pasos) y construye una API pequeña sin base de datos. Aprende primero método, path, `Request`, `Response`, Router y orden de middleware. Luego añade validación, errores y logs; la autenticación y persistencia vienen después.
...
| Necesito | Documento |
| --- | --- |
| proyecto mínimo y flujo de request | [Primeros pasos](/guides/express-primeros-pasos) |
| rutas, params, query, body y Router | [Routing, Request y Response](/guides/express-routing-request-response) |
| `app.use`, `next` y orden | [Middlewares](/guides/express-middlewares) |
| validar y transformar entradas | [Contratos de entrada](/guides/express-validacion-contratos) |
| errores async y handler final | [Manejo de errores](/guides/express-error-handling) |
| logs estructurados y correlación | [Logging](/guides/express-logging) |
| headers, límites y endurecimiento | [Seguridad](/guides/express-seguridad) |
| orígenes, preflight y credenciales | [CORS](/guides/express-cors) |
| recursos, verbos y status | [REST y CRUD](/guides/express-rest-crud) |
| listas grandes | [Paginación y filtrado](/guides/express-api-paginacion) |
| envelope estable de errores | [Respuestas de error](/guides/express-api-error-responses) |
| tokens | [JWT](/guides/express-jwt) |
| sesión server-side | [Cookies y sesiones](/guides/express-cookies-sesiones) |
| proteger rutas | [Middleware de autenticación](/guides/express-auth-middleware) |
| autorización | [Roles y permisos](/guides/express-roles-permisos) |
| estructura por capas | [MVC y capas](/patterns/backend-mvc-structure) |
