...
Sigue el orden del sidebar. Empieza por [Primeros pasos](/guides/astro-getting-started) y [Estructura y configuración](/guides/astro-project-configuration). Después construye componentes, páginas y layouts antes de estudiar hidratación, Actions o middleware.
...
| Necesito | Documento |
| --- | --- |
| crear proyecto, comandos y estructura | [Primeros pasos](/guides/astro-getting-started) |
| `astro.config`, `site`, `base`, `output` | [Configuración](/guides/astro-project-configuration) |
| props, slots y composición | [Componentes Astro](/guides/astro-components-props-slots) |
| rutas fijas, dinámicas y redirects | [Routing](/guides/astro-routing) |
| layout, slot y contenido Markdown | [Layouts](/guides/astro-layouts) |
| `Astro.props`, `params`, `url`, cookies y locals | [Objeto Astro](/guides/astro-global-object) |
| estilos scoped, globales y variables | [Estilos](/guides/astro-styles) |
| scripts de navegador y eventos | [Scripts](/guides/astro-scripts) |
| SSG, SSR, adapters e hidratación | [Modos de renderizado](/guides/astro-rendering-modes) |
| contenido tipado y loaders | [Content Collections](/guides/astro-content-collections) |
| `client:*` | [Islas de UI](/guides/astro-islas) |
| `server:defer` | [Server Islands](/guides/astro-server-islands) |
| formularios y mutaciones tipadas | [Server Actions](/guides/astro-server-actions) |
| requests HTTP públicas | [Endpoints](/guides/astro-endpoints) |
| auth, redirects y contexto por request | [Middleware](/guides/astro-middleware) |
...
| Término | Significado |
| --- | --- |
| prerender o SSG | generar HTML durante el build (*Static Site Generation*) |
| SSR | generar HTML al recibir una request (*Server-Side Rendering*) |
