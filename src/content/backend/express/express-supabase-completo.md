...
- Alternativa: si Express también maneja el login (en vez del frontend), usar [JWT manual](/backend/express/express-auth-completa) o [better-auth](/backend/express/express-better-auth) en su lugar, y Supabase solo como base de datos (sin usar `supabase.auth` en absoluto).
