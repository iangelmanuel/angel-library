...
Express es una capa de routing y middleware sobre HTTP de Node.js. No reemplaza el runtime: usa sus procesos, módulos, red y modelo asíncrono. Si todavía no reconoces esos conceptos, empieza en [Node.js](/backend/node/nodejs).
