...
import express from "express"
// de terceros: paquete npm
import { logger } from "./middlewares/logger"

// propio: código del proyecto
...
- El orden de `app.use()` importa de verdad: un middleware de auth registrado _después_ de las rutas que debería proteger, no las protege — corre después de que el handler ya respondió.
