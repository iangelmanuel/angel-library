...
- Nunca loguear la contraseña en texto plano en ningún punto del flujo (ni siquiera "para debug") — ver [Logging de requests](/backend/express/express-logging) sobre no loguear datos sensibles.
