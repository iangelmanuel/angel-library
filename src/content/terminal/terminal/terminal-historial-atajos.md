...
- Un alias/función definido a mano en la terminal se pierde al cerrarla — igual que las variables de entorno de sesión (ver [Variables de entorno](/terminal/terminal/terminal-variables-entorno)), hay que persistirlo en el archivo de configuración de la shell para que sobreviva.
