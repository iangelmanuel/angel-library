...
- El perfil (`$PROFILE`) es exclusivo de PowerShell — no tiene relación con `.bashrc`/`.zshrc` de shells tipo Linux, ver [bash y zsh](/terminal/terminal/terminal-linux-cli).
