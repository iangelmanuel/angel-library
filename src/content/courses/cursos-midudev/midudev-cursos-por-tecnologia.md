...
Además de los cursos de esta tabla mantiene el bootcamp [JS Camp](/courses/cursos-midudev/midudev-jscamp-bootcamp), el curso interactivo [Aprende SQL](/courses/cursos-midudev/midudev-aprende-sql) y varios repositorios abiertos. Su comunidad se reúne en [Discord](https://discord.gg/midudev), donde se resuelven dudas y se comparten ofertas de trabajo.
