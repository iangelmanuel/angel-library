...
Resend integra directo con [React Email](/libraries/react-email) para armar el HTML del email como componentes en vez de strings:
...
- `RESEND_API_KEY` es un secreto — ver [Variables de entorno en Node](/guides/node-env-vars).
