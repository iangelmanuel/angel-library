...
- Este documento conserva la fotografía editorial de la auditoría del 7 de septiembre: partía de 718 Markdown y terminó con 721. El catálogo actual tiene **726 archivos** (**723 publicados**), **24 categorías** y **170 subcategorías**; las cifras históricas que aparecen en los resultados no describen el estado actual.
